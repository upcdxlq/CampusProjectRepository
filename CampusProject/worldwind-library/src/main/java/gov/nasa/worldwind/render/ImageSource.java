 ...
 * <p/>
 * ImageSource supports four source types: <ul> <li>Android {@link Bitmap}</li> <li>World Wind {@link
 * BitmapFactory}</li> <li>Android resource identifier</li> <li>File path</li> <li>Uniform Resource Locator
 * (URL)</li> </ul>
 * <p/>
...
public class ImageSource {
     ...
     */
    public static ImageSource fromBitmapFactory(BitmapFactory factory) {
        if (factory == null) {
            throw new IllegalArgumentException(
    ...
    public static ImageSource fromObject(Object source) {
        ...
        } else if (source instanceof BitmapFactory) {
            return fromBitmapFactory((BitmapFactory) source);
    ...
    public BitmapFactory asBitmapFactory() {
        return (this.type == TYPE_BITMAP_FACTORY) ? (BitmapFactory) this.source : null;
    }
