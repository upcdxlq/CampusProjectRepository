...
public class TiandituTer_cLayer extends RenderableLayer implements TileFactory {

    //protected TileFactory tiandituTileFactory;

    String urlAddress = "";

    public TiandituTer_cLayer()
    {
        this("http://t0.tianditu.com/ter_c/wmts");
    }

    public TiandituTer_cLayer(String serviceAddress)
    {
    ...
    public Tile createTile(Sector sector, Level level, int row, int column) {
        ...
        //瓦片URL串
        String urlString = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=ter&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level1+"&TileRow="+row1+"&TileCol=" + col1;
