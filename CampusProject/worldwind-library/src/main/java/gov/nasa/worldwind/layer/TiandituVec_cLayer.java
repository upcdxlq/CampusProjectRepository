...
**/
public class TiandituVec_cLayer extends RenderableLayer implements TileFactory {

    //protected TileFactory tiandituTileFactory;

    String urlAddress = "";

    public TiandituVec_cLayer()
    {
        this("http://t0.tianditu.com/vec_c/wmts");
    }

    public TiandituVec_cLayer(String serviceAddress)
    {
    ...
    public Tile createTile(Sector sector, Level level, int row, int column) {
        ...
        //瓦片URL串
        String urlString = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=vec&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level1+"&TileRow="+row1+"&TileCol=" + col1;
