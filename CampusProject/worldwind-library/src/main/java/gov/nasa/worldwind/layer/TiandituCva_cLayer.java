...
public class TiandituCva_cLayer extends RenderableLayer implements TileFactory {

    //protected TileFactory tiandituTileFactory;

    String urlAddress = "";

    public TiandituCva_cLayer() {
        this("http://t0.tianditu.com/cva_c/wmts");
    }

    public TiandituCva_cLayer(String serviceAddress) {
        ...
        surfaceImage.setImageOptions(new ImageOptions(WorldWind.RGBA_8888));
    ...
    public Tile createTile(Sector sector, Level level, int row, int column) {
        ...
        //瓦片URL串
        String urlString = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=cva&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix=" + level1 + "&TileRow=" + row1 + "&TileCol=" + col1;
